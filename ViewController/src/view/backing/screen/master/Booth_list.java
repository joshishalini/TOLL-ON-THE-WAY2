...
public class Booth_list {
    ...
    private RichSelectItem si1, si5;
    ...
    public void as(SelectionEvent selectionEvent) {
        // Add event code here...
    }
    ...
    public void bphase(PhaseEvent phaseEvent) {
       ...
       CheckStatus();
        ...
        try {
            ...
            ResultSet rs = stt.executeQuery("select id,name,state,city,phno from booth_detail group by id");
            while (rs.next()) {
